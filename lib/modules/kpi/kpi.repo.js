...
// يشمل الدورات التي يملكها الموظف والدورات التي نفّذ فيها عناصر إقفال فعلياً لغيره
...
function findExecutedElsewhereCourses(userId, periodStart, periodEnd) {
  return prisma.course.findMany({
    where: {
