...
function renderTitleBox(courseName, tagline) {
  return `
    <div style="margin:10px 0 12px; padding:12px 14px; background:linear-gradient(135deg,#016564 0%,#498983 100%); border-radius:14px;">
      <h2 style="margin:0; color:#013b3c; font-size:19px; font-weight:900; line-height:1.35; font-family:'Cairo',Tahoma,Arial,sans-serif;">${escapeHtml(courseName)}</h2>
      <p style="margin:6px 0 0; color:#013b3c; font-size:12px; opacity:0.95; font-family:'Cairo',Tahoma,Arial,sans-serif;">${escapeHtml(tagline)}</p>
    </div>
  `;
}
