...
function renderTitleBox(courseName, tagline) {
  return `
    <div style="margin:10px 0 12px; padding:12px 14px; background:#f0f6f5; border-right:5px solid #016564; border-radius:10px;">
      ...
      <p style="margin:6px 0 0; color:#6b7280; font-size:12px; font-family:'Cairo',Tahoma,Arial,sans-serif;">${escapeHtml(tagline)}</p>
    </div>
  `;
}
